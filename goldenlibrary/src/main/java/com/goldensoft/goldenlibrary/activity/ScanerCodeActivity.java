...
import com.goldensoft.goldenlibrary.camera.CameraManager;
import com.goldensoft.goldenlibrary.camera.CaptureActivityHandler;
import com.goldensoft.goldenlibrary.camera.InactivityTimer;
import com.goldensoft.goldenlibrary.constant.GdConstant;
import com.goldensoft.goldenlibrary.interfaces.OnRxScanerListener;
import com.goldensoft.goldenlibrary.qrcode.GdQrBarTool;
import com.goldensoft.goldenlibrary.utils.GdAnimationTool;
import com.goldensoft.goldenlibrary.utils.GdBeepTool;
import com.goldensoft.goldenlibrary.utils.GdDataTool;
import com.goldensoft.goldenlibrary.utils.GdPhotoTool;
import com.goldensoft.goldenlibrary.utils.GdSPTool;
import com.goldensoft.goldenlibrary.utils.GdStatusBarUtil;
import com.goldensoft.goldenlibrary.view.GdToast;
import com.goldensoft.goldenlibrary.view.dialog.GdDialogSure;
...
public class ScanerCodeActivity extends BaseActivity {
     ...
     * 扫描结果显示框
     */
    private GdDialogSure rxDialogSure;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GdStatusBarUtil.setNoTitle(this);

        setContentView(R.layout.activity_scaner_code);
        GdStatusBarUtil.setTransparent(this);
        //界面控件初始化
        initView();
        //权限初始化
        initPermission();
    ...
    private void initScanerAnimation() {
        ...
        GdAnimationTool.ScaleUpDowm(mQrLineView);
    }
    ...
    public void btn(View view) {
        ...
        if (viewId == R.id.top_mask) {
            ...
            GdPhotoTool.openLocalImage(mContext);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                // 开始对图像资源解码
                Result rawResult = GdQrBarTool.decodeFromPhoto(photo);
                if (rawResult != null) {
    ...
    private void initDialogResult(Result result) {
        ...
        if (rxDialogSure == null) {
            //提示弹窗
            rxDialogSure = new GdDialogSure(mContext);
        }
        ...
        GdSPTool.putContent(mContext, GdConstant.SP_SCAN_CODE, GdDataTool.stringToInt(GdSPTool.getContent(mContext, GdConstant.SP_SCAN_CODE)) + 1 + "");
    }

    public void handleDecode(Result result) {
        inactivityTimer.onActivity();
        //扫描成功之后的振动与声音提示
        GdBeepTool.playBeep(mContext, vibrate);

        String result1 = result.getText();
        Log.v("二维码/条形码 扫描结果", result1);
        if (mScanerListener == null) {
            GdToast.success(result1);
