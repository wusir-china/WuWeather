...
import com.goldensoft.goldenlibrary.camera.GdPreviewCallback;
...
public final class CameraManager {
     ...
     */
    private final GdPreviewCallback previewCallback;
    /**
     * Autofocus callbacks arrive here, and are dispatched to the Handler which requested them.
     */
    private final GdAutoFocusCallback autoFocusCallback;
    ...
    private CameraManager(Context context) {
        ...
        previewCallback = new GdPreviewCallback(configManager, useOneShotPreviewCallback);
        autoFocusCallback = new GdAutoFocusCallback();
    }
    ...
    public GdPreviewCallback getPreviewCallback() {
        return previewCallback;
    }

    public GdAutoFocusCallback getAutoFocusCallback() {
