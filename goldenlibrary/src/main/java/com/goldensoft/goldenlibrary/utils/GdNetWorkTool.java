        ...
        if (ni != null && ni.isConnectedOrConnecting()) {
            ...
            switch (ni.getType()) {//获取当前网络的状态
                case ConnectivityManager.TYPE_WIFI:// wifi的情况下
                    ...
                    GdToast.success(context,"切换到wifi环境下",1000,true);
                ...
                case ConnectivityManager.TYPE_MOBILE:
                    ...
                    switch (ni.getSubtype()) {
                        ...
                        case TelephonyManager.NETWORK_TYPE_IDEN:
                            netType = NETWORK_2G;
                            //GdToast.showShortToast(context,"切换到2G环境下");
                            GdToast.info("切换到2G环境下");
                            break;
                        ...
                        case NETWORK_TYPE_TD_SCDMA:
                            netType = NETWORK_3G;
                            //GdToast.showShortToast(context,"切换到3G环境下");
                            GdToast.info("切换到3G环境下");
                            break;
                        case TelephonyManager.NETWORK_TYPE_LTE:

                        case NETWORK_TYPE_IWLAN:
                            netType = NETWORK_4G;
                            //GdToast.showShortToast(context,"切换到4G环境下");
                            GdToast.info("切换到4G环境下");
                            break;
                        default:
                            ...
                            //GdToast.showShortToast(context,"未知网络");
                            GdToast.normal("未知网络");
                    }
                    break;
                default:
            ...
            netType = NETWORK_NO;
            GdToast.error(context,"当前无网络连接",1000,true);
