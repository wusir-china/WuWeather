...
import static com.goldensoft.goldenlibrary.utils.GdDataTool.bytes2HexString;
import static com.goldensoft.goldenlibrary.utils.GdDataTool.hexString2Bytes;
...
public class GdEncryptTool {
    ...
    public static byte[] encryptDES2Base64(byte[] data, byte[] key) {
        return GdEncodeTool.base64Encode(encryptDES(data, key));
    }
    ...
    public static byte[] decryptBase64DES(byte[] data, byte[] key) {
        return decryptDES(GdEncodeTool.base64Decode(data), key);
    }
    ...
    public static byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
        return GdEncodeTool.base64Encode(encrypt3DES(data, key));
    }
    ...
    public static byte[] decryptBase64_3DES(byte[] data, byte[] key) {
        return decrypt3DES(GdEncodeTool.base64Decode(data), key);
    }
    ...
    public static byte[] encryptAES2Base64(byte[] data, byte[] key) {
        return GdEncodeTool.base64Encode(encryptAES(data, key));
    }
    ...
    public static byte[] decryptBase64AES(byte[] data, byte[] key) {
        return decryptAES(GdEncodeTool.base64Decode(data), key);
    }
