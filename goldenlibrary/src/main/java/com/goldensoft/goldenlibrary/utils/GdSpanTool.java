...
/**
 * SpannableString相关
 * Created by golden on 2018/4/9.
 */

public class GdSpanTool {
     ...
     *             </ul>
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setBullet(@ColorInt final int color,
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setFontProportion(final float proportion) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setFontXProportion(final float proportion) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setStrikethrough() {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setUnderline() {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setSuperscript() {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setSubscript() {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                             final Blur style) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final float dx,
                               final float dy,
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool appendImage(@DrawableRes final int resourceId, @Align final int align) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link GdSpanTool} instance
     */
    public GdSpanTool appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
...
//            }
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(golden.getContext().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            golden.getContext().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(golden.getContext().getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(golden.getContext(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
