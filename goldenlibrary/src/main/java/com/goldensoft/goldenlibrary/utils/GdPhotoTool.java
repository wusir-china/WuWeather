...
import static com.goldensoft.goldenlibrary.utils.GdFileTool.getDataColumn;
import static com.goldensoft.goldenlibrary.utils.GdFileTool.isDownloadsDocument;
import static com.goldensoft.goldenlibrary.utils.GdFileTool.isExternalStorageDocument;
import static com.goldensoft.goldenlibrary.utils.GdFileTool.isGooglePhotosUri;
import static com.goldensoft.goldenlibrary.utils.GdFileTool.isMediaDocument;
...
public class GdPhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            GdToast.error(context,"请先获取写入SDCard权限",1000,true);
