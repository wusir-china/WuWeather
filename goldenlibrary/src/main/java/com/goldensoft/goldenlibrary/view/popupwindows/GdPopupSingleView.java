package com.goldensoft.goldenlibrary.view.popupwindows;
...
import com.goldensoft.goldenlibrary.model.ActionItem;
import com.goldensoft.goldenlibrary.utils.GdDeviceTool;
import com.goldensoft.goldenlibrary.utils.GdImageTool;
 ...
 */
public class GdPopupSingleView extends PopupWindow {
    // 列表弹窗的间隔
    ...
    public GdPopupSingleView(Context context) {
        // 设置布局的参数
        this(context, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    }

    public GdPopupSingleView(Context context, int width, int height) {
        ...
        // 获得屏幕的宽度和高度
        mScreenWidth = GdDeviceTool.getScreenWidth(mContext);
        mScreenHeight = GdDeviceTool.getScreenHeight(mContext);
    ...
    public GdPopupSingleView(Context context, int width, int height, int layout) {
        this.mContext = context;
    ...
    public void show(View view) {
        ...
        // 显示弹窗的位置
        showAtLocation(view, popupGravity, mScreenWidth - LIST_PADDING - (getWidth() / 2), mRect.bottom + GdImageTool.dp2px(7.5f));
    }
