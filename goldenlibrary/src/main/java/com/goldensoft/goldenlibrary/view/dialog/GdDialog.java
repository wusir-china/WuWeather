...
public class GdDialog extends Dialog {
    ...
    public GdDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public GdDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
     ...
     */
    public GdDialog(Context context, float alpha, int gravity) {
        super(context);
